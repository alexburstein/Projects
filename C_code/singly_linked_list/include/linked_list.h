...
/*############################################################################
  # Description:slist_node_t *SlistCreateNode(void *data, slist_node_t *next_node)
	removes node from linked list. CAUSES POINTER INVALIDATION	
  # Parameters:
	current_node - node to remove
  # Return Value:
	a node with the removed data
############################################################################*/
...
/*############################################################################
  ...
  # Parameters:
	current node. Do not use on last node in link list!
  # Return Value:
	address of removed node
############################################################################*/
